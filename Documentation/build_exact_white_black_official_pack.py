...
def build_white_sheet_black_text_official_pack():
    print("=== BUILDING EXACT WHITE SHEET & BLACK TEXT OFFICIAL SUBMISSION DOCUMENTS ===")
    ...
    # Exact Shopping List (Rs. 15,000 Total, max single item Rs. 6,500 <= Rs. 10,000 limit)
    SHOPPING_BILLS = [
        ("1", "INV-2026-01", "15/06/2026", "1TB External High-Speed SSD (Model & Journey Video Backup)", "Rs. 6,500.00"),
        ("2", "INV-2026-02", "22/06/2026", "6x3ft Roll-Up Standee & 3 Hardbound Project Reports Printing", "Rs. 4,500.00"),
        ("3", "INV-2026-03", "05/07/2026", "Wireless USB Microphone & Presenter (Voice AI Stage Demo)", "Rs. 4,000.00"),
    ]

    # ReportLab Styles (Pure White Background, Pure Black Text, Times New Roman)
    ...
    # -------------------------------------------------------------------------
    # DOCUMENT 1: PRE-RECEIPT (WHITE SHEET & BLACK TEXT)
    # -------------------------------------------------------------------------
    print("Generating Document 1: PRE-RECEIPT (White Sheet, Black Text)...")
    ...
    # PDF (Pure White Background, Black Text)
    ...
    print("[SUCCESS] Document 1 (PRE-RECEIPT) White/Black PDF & DOCX Generated!")

    # -------------------------------------------------------------------------
    # DOCUMENT 2: BILL SUMMARY (WHITE SHEET & BLACK TEXT WITH SHOPPING LIST)
    # -------------------------------------------------------------------------
    print("Generating Document 2: BILL SUMMARY (White Sheet, Black Text, Shopping List)...")
    ...
    print("[SUCCESS] Document 2 (BILL SUMMARY) White/Black PDF & DOCX Generated!")

    # -------------------------------------------------------------------------
    # DOCUMENT 3: UTILISATION CERTIFICATE (WHITE SHEET & BLACK TEXT)
    # -------------------------------------------------------------------------
    print("Generating Document 3: UTILISATION CERTIFICATE (White Sheet, Black Text)...")
    ...
    print("[SUCCESS] Document 3 (UTILISATION CERTIFICATE) White/Black PDF & DOCX Generated!")

if __name__ == "__main__":
    build_white_sheet_black_text_official_pack()
