...
def build_atoz_expanded_poster():
    print("=== BUILDING A-TO-Z COMPLETE EXPLANATION POSTER FOR PDF & PPTX ===")
    ...
    # -------------------------------------------------------------------------
    # PART 1: A3 LANDSCAPE PDF (1190.55 x 841.89 pt) WITH A-TO-Z EXPLANATION
    # -------------------------------------------------------------------------
    ...
    # COLUMN 1 (LEFT: 375pt) - A TO Z ABSTRACT & HIGHLIGHTS
    ...
    # COLUMN 2 (CENTER: 390pt) - A TO Z METHODOLOGY, PROCEDURE, & DATASET
    ...
    # COLUMN 3 (RIGHT: 375pt) - A TO Z INPUT/OUTPUT, CONCLUSION, & SYSTEM INTERFACE
    c3_1 = [
    ...
    doc.build(story)
    print(f"[SUCCESS] PDF with Complete A-to-Z Explanation Generated at: {target_pdf_final}")

    shutil.copyfile(target_pdf_final, target_pdf_main)
    shutil.copyfile(target_pdf_final, submission_pdf)

    # -------------------------------------------------------------------------
    # PART 2: A3 PPTX (KEFFI_POSTER.pptx) WITH COMPLETE A-TO-Z EXPLANATION
    # -------------------------------------------------------------------------
    prs = Presentation()
    ...
    # Column 1 (Left) - A TO Z ABSTRACT & HIGHLIGHTS
    ...
    # Column 2 (Center) - A TO Z METHODOLOGY, PROCEDURE, & DATASET
    add_spacious_ppt_section(
        slide,
        "3. METHODOLOGY",
    ...
    # Column 3 (Right) - A TO Z INPUT/OUTPUT, CONCLUSION, & SYSTEM INTERFACE
    add_spacious_ppt_section(
        slide,
        "6. INPUT AND OUTPUT",
        [
    ...
    print(f"[SUCCESS] Complete A-to-Z PPTX Generated at: {target_pptx_main}")

if __name__ == "__main__":
    build_atoz_expanded_poster()
