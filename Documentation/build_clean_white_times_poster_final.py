...
def build_clean_white_times_poster():
    print("=== BUILDING CLEAN WHITE BACKGROUND TIMES NEW ROMAN POSTER (1-7 ORDER, NO BOXES, NEW IMAGE) ===")
    ...
    # -------------------------------------------------------------------------
    # PART 1: CLEAN WHITE A3 LANDSCAPE PDF (1190.55 x 841.89 pt)
    # -------------------------------------------------------------------------
    ...
    doc.build(story)
    print(f"[SUCCESS] Clean White Background PDF Generated at: {target_pdf_final}")

    shutil.copyfile(target_pdf_final, target_pdf_main)
    shutil.copyfile(target_pdf_final, submission_pdf)

    # -------------------------------------------------------------------------
    # PART 2: CLEAN WHITE A3 TIMES NEW ROMAN PPTX (KEFFI_POSTER.pptx)
    # -------------------------------------------------------------------------
    prs = Presentation()
    ...
    print(f"[SUCCESS] Clean White Background Times New Roman PPTX Generated at: {target_pptx_main}")

if __name__ == "__main__":
    build_clean_white_times_poster()
