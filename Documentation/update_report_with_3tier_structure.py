...
def update_report_3tier():
    print("=== UPDATING MASTER REPORT WITH 3-TIER THERAPEUTIC RESPONSE ARCHITECTURE ===")
    ...
    add_p("  1.4 3-Tier Clinical Therapeutic Response Architecture .............................. 8")
    ...
    add_p("  4.2 Use Case Analysis for Model Development ......................................... 20")
    ...
    # 1.4 DEEP 3-TIER THERAPEUTIC RESPONSE ARCHITECTURE
    add_h2("1.4 3-Tier Clinical Therapeutic Response Architecture")
    add_p("To eliminate generic, overly short, or dismissive responses typical of baseline chatbots, Keffi AI implements a deterministic 3-Tier Clinical Therapeutic Response Architecture. Every AI response is dynamically constructed across three distinct therapeutic components:")
    add_p("1. Tier 1: Empathetic Validation & Unconditional Positive Regard (Rogerian Care) — The response opens by acknowledging the user's emotional state without judgment, validating their feelings to establish psychological safety and trust within the Keffi Sanctuary.")
    add_p("2. Tier 2: Psychoeducation & Neurobiological Context — The system provides evidence-based biological explanations (e.g. explaining how stress triggers cortisol/adrenaline surges or amygdala hyperactivity). This de-stigmatizes distress by reassuring the patient that their reaction is a natural physiological process.")
    add_p("3. Tier 3: Evidence-Based CBT Micro-Intervention — The response concludes with an actionable physical grounding exercise (such as holding a heavy object, 5-4-3-2-1 sensory mapping, or 4-7-8 breathing) accompanied by interactive quick-action prompt chips.")
    ...
    print(f"[SUCCESS] 3-Tier Therapeutic Report DOCX Saved at: {target_docx_path}")
