...
def expand_abstract_and_highlights():
    print("=== EXPANDING ABSTRACT & HIGHLIGHTS WITH EXTRA DETAILED CLINICAL EXPLANATIONS ===")
    ...
    # -------------------------------------------------------------------------
    # PART 1: A3 LANDSCAPE PDF (1190.55 x 841.89 pt) WITH EXPANDED ABSTRACT & HIGHLIGHTS
    # -------------------------------------------------------------------------
    ...
    # COLUMN 1 (LEFT: 375pt) - EXPANDED ABSTRACT!
    ...
    # EXPANDED HIGHLIGHTS OF THE PROJECT!
    c1_2 = [
    ...
    doc.build(story)
    print(f"[SUCCESS] Expanded Abstract & Highlights PDF Generated at: {target_pdf_final}")

    shutil.copyfile(target_pdf_final, target_pdf_main)
    shutil.copyfile(target_pdf_final, submission_pdf)

    # -------------------------------------------------------------------------
    # PART 2: A3 PPTX (KEFFI_POSTER.pptx) WITH EXPANDED ABSTRACT & HIGHLIGHTS
    # -------------------------------------------------------------------------
    prs = Presentation()
    ...
    print(f"[SUCCESS] Expanded PPTX Generated at: {target_pptx_main}")

if __name__ == "__main__":
    expand_abstract_and_highlights()
