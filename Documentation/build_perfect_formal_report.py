...
def create_perfect_formal_report():
    print("=== CREATING PERFECT FORMAL PROJECT REPORT (NO RAW API TAGS, CLEAN CODE, UPDATED PHOTOS) ===")
    ...
    # Anna University 1-inch Margins
    ...
    # HUMANIZED FORMAL ABSTRACT (NO RAW API TAGS)
    add_h1("ABSTRACT")
    ...
    add_p("  4.2 Use Case Analysis for Model Development ................................. me 20")
    ...
    # CHAPTER 6: CLEAN & OPTIMIZED ESSENTIAL CODE
    ...
    # CHAPTER 7: UPDATED SCREENSHOTS & NEW POSTER
    ...
    # Save output DOCX
    out_docx_path = r"e:\Keffi Ai\Documentation\KEFFI_PERFECT_FORMAL_PROJECT_REPORT.docx"
    doc.save(out_docx_path)
    print(f"[SUCCESS] Perfect Formal DOCX Saved at: {out_docx_path}")

    # Convert to PDF via Word COM Engine
    out_pdf_path = r"e:\Keffi Ai\Documentation\PDF_Print_Copies\KEFFI_PERFECT_FORMAL_PROJECT_REPORT.pdf"
    os.makedirs(os.path.dirname(out_pdf_path), exist_ok=True)

    print(f"=== CONVERTING FORMAL DOCX TO PDF VIA WORD COM ENGINE ===")
