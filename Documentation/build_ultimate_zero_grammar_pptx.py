...
def build_ultimate_deck():
    print("=== BUILDING ULTIMATE 20-SLIDE PRESENTATION WITH DEEP TEXT & ZERO GRAMMAR MISTAKES ===")

    prs = Presentation()
    prs.slide_width = Inches(13.333)
    prs.slide_height = Inches(7.5)

    # Color Palette matching Review-2 PPT aesthetic: Dark Executive Teal, Sage Accent, Gold Highlight, Dark Slate Body
    ...
    slides = [
        ...
        # Slide 2
        {
            ...
            "category_desc": "Outpatient psychiatric care suffers from a severe structural flaw: patients see therapists for 1 hour weekly, leaving 167 hours unmonitored.",
            "bullets": [
        ...
        # Slide 3
        {
            "category": "PROBLEM DEFINITION & EXISTING SYSTEM LIMITATIONS",
            "title": "CLINICAL PROBLEM STATEMENT & LIMITATIONS OF CURRENT SOLUTIONS",
            ...
            "bullets": [
                ...
                "5. High Attrition & Dropout: Outpatients disengage due to lack of continuous bio-behavioral monitoring between weekly therapy visits."
            ]
        },
        # Slide 4
        {
        ...
        # Slide 6
        {
            ...
            "bullets": [
                ...
                "20 Attrition Types & 17 Loss of Follow-up Categories: Tracking voluntary dropout, stigma, non-compliance, and administrative loss.",
        ...
        # Slide 8
        {
            ...
            "category_desc": "Single-modality text analysis fails when patients hide distress behind neutral words. Multimodal fusion captures true physiological affect.",
            "bullets": [
        ...
        # Slide 19
        {
            "category": "CONCLUSION & SOCIETAL IMPACT",
            "title": "CONCLUSION & SOCIETAL IMPACT",
            "subtitle": "Transforming Mental Healthcare Access Across Tamil Nadu and India",
            "bullets": [
    ...
    print(f"[SUCCESS] Built Ultimate 20-Slide PPTX with zero grammar mistakes at:\n  1. {out_path_1}\n  2. {out_path_2}")
